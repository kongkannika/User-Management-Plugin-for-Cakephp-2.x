...
Router::connect('/profile', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'profile'));
...
Router::connect('/viewTransaction/*', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'viewTransaction'));
