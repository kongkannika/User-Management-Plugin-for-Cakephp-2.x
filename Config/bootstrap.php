...
function UsermgmtInIt() {
	...
	if (!defined('EMAIL_FROM_ADDRESS')) {
		define('EMAIL_FROM_ADDRESS', 'coca.akat@gmail.com');
	}
	...
	if (!defined('EMAIL_FROM_NAME')) {
		define('EMAIL_FROM_NAME', 'Membership Card');
	}
	...
	/*
	  set login redirect url, it means when user gets logged in then site will redirect to this url.
	 */
	if (!defined('ADMIN_LOGIN_REDIRECT_URL')) {
		define('ADMIN_LOGIN_REDIRECT_URL', '/traders');
	}
	...
	if (!defined('LOGIN_COOKIE_NAME')) {
		define('LOGIN_COOKIE_NAME', 'MSCCookie');
	}
